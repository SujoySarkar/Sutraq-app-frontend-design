...
import 'package:sutraq/UI/Try_Sutraq/transactionpintwo.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(
              "This is your personal secured pin,used to",
              style: TextStyle(
                color: Colors.black,
            ...
            Text(
              "autthorize transactions with Sutraw",
              style: TextStyle(
                color: Colors.black,
                fontSize: MediaQuery.of(context).size.height / 45,
              ),
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Transactionpintwo()));
                      },
